...
document.getElementById('getButton').addEventListener('click', apiRequest)
 ...
 function apiRequest(){
    ...
    const alienData = aliens[alienName];
    

        if (alienData){
        document.getElementById('alienName').innerText = alienData.speciesName
        document.getElementById('alienWorld').innerText = alienData.homeworld
        document.getElementById('alienFeatures').innerText = alienData.features
        document.getElementById('alienFacts').innerText = alienData.interestingFact
        document.getElementById('alienExamples').innerText = alienData.notableExamples
        document.getElementById('alienImage').src = alienData.image
        document.getElementById('alienCaption').innerText = alienData.speciesName
        } else {
            console.log('Alien not found in the data.');
        }
}